    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text('Shipment Details' , style: TextStyle(fontWeight: FontWeight.bold , color: Colors.black),),
        ),
          ...
          child: Center(
            child: InkWell(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text("Confirmed || Items Received",style: TextStyle(color: Colors.white , fontSize: 15.0),),
                ),
              ),
            ),
          ),
