                      ...
                      Container(
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              Text("50%",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal),),
                              Text("OFF",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontSize: 12.0),),
                            ],
                          ),
                        ),
                      ),
